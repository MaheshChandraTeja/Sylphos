//! Browser shell modules: navigation, tabs, persistent history, chrome rendering, cache, image loading, resources, stylesheets, DOM, CSSOM, and interaction.
...
pub(crate) use resources::{ResourceRequest, ResourceScheduler, ResourceSummary};
